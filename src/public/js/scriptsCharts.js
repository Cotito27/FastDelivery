...
var optionsArea = {
  ...
  title: {
    text: 'Estadística de Visitas Diarias',
    align: 'left',
    style: {
      fontSize: '18px'
    }
...
var optionDonut = {
  ...
  colors: colorPalette,
  title: {
    text: 'Ventas del Departamento',
    style: {
      fontSize: '18px'
    }
  },
  series: [21, 23, 19, 14, 6],
  labels: ['Ropa', 'Productos alimenticios', 'Electrodomésticos', 'Utilidad de cocina', 'Productos de limpieza'],
  legend: {
    position: 'left',
    offsetY: 80
  }
